...
enum SHADER_REG_LIGHT
{
	SHADER_REG_PS_DIRECTIONAL_LIGHT=0,
	SHADER_REG_PS_POINT_LIGHT=1,
	SHADER_REG_PS_SPOT_LIGHT=2
};
enum SHADER_REG_TEXTURE
{
	SHADER_REG_TEXTURE_STD=0,
	SHADER_REG_TEXTURE_NORMAL=1,
	SHADER_REG_TEXTURE_CM=2
};
